package net.gremlinarvinr.gremlinpets.entity.animations;
...
public class ModAnimationDefinitions {
    // rat
    public static final AnimationDefinition RAT_IDLE = AnimationDefinition.Builder.withLength(2f).looping()
            .addAnimation("rat",
    ...
    public static final AnimationDefinition RAT_WALK = AnimationDefinition.Builder.withLength(2f).looping()
            ...
            .addAnimation("left_front_leg",
                    new AnimationChannel(AnimationChannel.Targets.ROTATION,
                            ...
                            new Keyframe(1f, KeyframeAnimations.degreeVec(0f, 0f, 0f),
                                    AnimationChannel.Interpolations.LINEAR))).build();
    public static final AnimationDefinition RAT_SIT = AnimationDefinition.Builder.withLength(2f).looping()
            .addAnimation("rat",
                    new AnimationChannel(AnimationChannel.Targets.POSITION,
